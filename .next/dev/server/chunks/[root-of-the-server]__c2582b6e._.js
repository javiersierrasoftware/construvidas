...
"[project]/Projects/en gravity/tritonweb/src/app/api/store/checkout/create-payment/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!name || !email || !cedula || !address || !phoneNumber || !cartItems || cartItems.length === 0 || totalAmount === undefined) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Faltan datos obligatorios para la orden."
            }, {
                status: 400
            });
        }
        ...
        const productsInDb = await __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$src$2f$models$2f$Product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            _id: {
                $in: productIds
            }
        });
        if (productsInDb.length !== cartItems.length) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Algunos productos en el carrito no son válidos."
            }, {
                status: 400
            });
        }
        ...
        for (const item of cartItems){
            ...
            if (dbProduct.price !== item.price) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: `Precio del producto no coincide para: ${item.name}`
                }, {
                    status: 400
                });
            }
        ...
        if (calculatedTotal !== totalAmount) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "El total del carrito no coincide con el calculado en el servidor."
            }, {
                status: 400
            });
        }
        ...
        if (token) {
            try {
                ...
                const userPayload = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].verify(token, secret);
        ...
        const newOrder = new __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$src$2f$models$2f$Order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({
            user: userId,
            guestInfo: {
                name,
                email,
        ...
        const redirectUrl = `${("TURBOPACK compile-time value", "http://localhost:3000")}/tienda/checkout/status/${newOrder._id.toString()}`;
        ...
        if (!wompiResponse.ok) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$src$2f$models$2f$Order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(newOrder._id); // Rollback
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c2582b6e._.js.map