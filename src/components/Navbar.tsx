                    ...
                    <div className="mt-2">
                      ...
                      <div className="px-2 pb-2">
                        <div className="mt-2 flex flex-col gap-1">
                            ...
                            className="block px-6 py-2.5 text-xs font-bold bg-secondary-50/50 text-secondary-700 hover:bg-secondary-100 transition rounded-xl"
                            onClick={() => setMenuOpen(false)}
                            >
      ...
      >
        ...
        <div className="flex flex-col p-8 overflow-y-auto h-[calc(100vh-100px)]">
          ...
          <div className="flex flex-col gap-2">
            ...
            <MobileLink href="/devocionales" onClick={closeMobile}>Devocional</MobileLink>
...
function NavLinks() {
  return (
    <div className="flex items-center gap-10">
      ...
      <Link href="/devocionales" className="text-slate-600 hover:text-secondary-600 transition font-bold uppercase tracking-widest text-[10px]">Devocional</Link>
