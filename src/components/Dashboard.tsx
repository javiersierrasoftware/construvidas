...
export default function Dashboard() {
  return (
    <section className="max-w-5xl mx-auto px-4 mt-10 space-y-6">
      ...
      {/* Título */}
      <h1 className="text-2xl font-bold">Bienvenido a CONSTRUVIDAS</h1>

      {/* GRID PRINCIPAL */}
      <div className="grid gap-4 md:grid-cols-2">

        {/* Próximo entrenamiento */}
        <div className="rounded-2xl p-[2px] bg-gradient-to-br from-secondary-500 via-accent-400 to-pink-500 shadow-lg">
          <div className="bg-white rounded-2xl p-4 flex items-center gap-4">
            <div className="h-12 w-12 flex items-center justify-center rounded-xl bg-white/10">
              <Dumbbell size={24} />
            </div>
            <div>
              <p className="text-xs text-slate-700">Próximo entrenamiento</p>
        ...
        <div className="bg-[#111] rounded-2xl p-4 flex items-center gap-4 border border-white/5">
          ...
          <div>
            <p className="text-xs text-slate-700">Kilómetros del mes</p>
        ...
        {/* Próximo evento */}
        <div className="bg-[#111] rounded-2xl p-4 flex items-center gap-4 border border-white/5">
          <div className="h-12 w-12 flex items-center justify-center rounded-xl bg-accent-600/20">
            <CalendarDays size={24} className="text-accent-500" />
          </div>
          <div>
            <p className="text-xs text-slate-700">Próximo evento</p>
            <p className="text-sm font-semibold">
        ...
        <div className="bg-[#111] rounded-2xl p-4 flex items-center gap-4 border border-white/5">
          ...
          <div>
            <p className="text-xs text-slate-700">Clima hoy</p>
