        ...
        <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div>
            ...
            <p className="text-slate-700 text-sm">
              Panel de administración para publicar eventos oficiales CONSTRUVIDAS.
            </p>
          </div>
          ...
          <section className="space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-4 text-xs">
              <div className="space-y-2 border border-white/10 rounded-xl p-3">
                ...
                <label className="block text-slate-800">
                  Precio
                  <input type="text" name="reg1Price" value={form.reg1Price} onChange={handleChange} placeholder="00.000" className="w-full mt-1 bg-white/40 border border-white/10 rounded-xl px-2 py-1" />
                </label>
              </div>
              ...
              <div className="space-y-2 border border-white/10 rounded-xl p-3">
                ...
                <label className="block text-slate-800">
                  Precio
                  <input type="text" name="reg2Price" value={form.reg2Price} onChange={handleChange} placeholder="20.000" className="w-full mt-1 bg-white/40 border border-white/10 rounded-xl px-2 py-1" />
                </label>
              </div>
              ...
              <div className="space-y-2 border border-white/10 rounded-xl p-3">
                ...
                <label className="block text-slate-800">
                  Precio
                  <input type="text" name="reg3Price" value={form.reg3Price} onChange={handleChange} placeholder="50.000" className="w-full mt-1 bg-white/40 border border-white/10 rounded-xl px-2 py-1" />
                </label>
              </div>
            </div>
          </section>
