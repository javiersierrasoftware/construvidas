...
"[project]/Software/construvidas/src/lib/mail.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Software$2f$construvidas$2f$node_modules$2f$nodemailer$2f$lib$2f$nodemailer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Software/construvidas/node_modules/nodemailer/lib/nodemailer.js [app-route] (ecmascript)");
;
const transporter = __TURBOPACK__imported__module__$5b$project$5d2f$Software$2f$construvidas$2f$node_modules$2f$nodemailer$2f$lib$2f$nodemailer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createTransport({
    service: "gmail",
    auth: {
...
async function sendEmail({ to, subject, html }) {
    try {
        const info = await transporter.sendMail({
            from: `"ConstruVidas Web" <${process.env.GMAIL_USER}>`,
            to,
            subject,
            html
        });
...
async function sendWelcomeEmail(to, name) {
    const subject = "¡Bienvenido a ConstruVidas Web!";
    const html = `
    <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
      <h1 style="color: #00bcd4;">¡Hola, ${name}!</h1>
      <p>Gracias por unirte a la comunidad <strong>ConstruVidas</strong>.</p>
      ...
      <br/>
      <p>Atentamente,</p>
      <p><strong>El equipo de ConstruVidas</strong></p>
    </div>
  `;
    return sendEmail({
        to,
...
"[project]/Software/construvidas/src/app/api/auth/register/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Software$2f$construvidas$2f$src$2f$lib$2f$mail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Software/construvidas/src/lib/mail.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(req) {
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$Software$2f$construvidas$2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            email
        });
        if (existing) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Software$2f$construvidas$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const hashed = await __TURBOPACK__imported__module__$5b$project$5d2f$Software$2f$construvidas$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(password, 10);
        const newUser = await __TURBOPACK__imported__module__$5b$project$5d2f$Software$2f$construvidas$2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            name,
            email,
            password: hashed,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Software$2f$construvidas$2f$src$2f$lib$2f$mail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendWelcomeEmail"])(email, name).catch(console.error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Software$2f$construvidas$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__96c3b96a._.js.map