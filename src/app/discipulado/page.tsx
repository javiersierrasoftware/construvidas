    ...
    <div className="max-w-6xl mx-auto px-4 pt-28 pb-20">
      ...
      <section className="mb-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            "Plataforma virtual interactiva con módulos y lecciones",
            "Estudio sistemático de la Biblia y versículos clave",
            "Videos explicativos y recursos descargables",
            "Evaluaciones de comprensión y seguimiento personalizado",
            "Integración en una Casa de Vida y mentorio",
            "Acompañamiento espiritual continuo",
            "Seminarios de sanidad interior y formación",
            "Capacitación en liderazgo cristiano",
            "Certificación de avance de discipulado"
          ].map((item, index) => (
      ...
      {/* BOTÓN FINAL */}
      <div className="text-center mt-12 flex flex-col items-center justify-center gap-4">
        <Link
          href="/cursos"
          className="bg-slate-900 text-white font-gobold px-12 py-5 rounded-2xl text-xl uppercase tracking-widest hover:bg-secondary-600 transition-all shadow-xl shadow-slate-900/20 inline-block transform hover:-translate-y-1"
        >
          Iniciar mi proceso hoy
        </Link>
        <p className="text-xs font-semibold text-slate-400 uppercase tracking-widest">
          Ingresa a la Plataforma Virtual de Formación en Cristo
        </p>
      </div>
    </div>
  );
