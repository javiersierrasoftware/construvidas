...
"[project]/Software/construvidas/src/models/Event.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Software$2f$construvidas$2f$src$2f$models$2f$Event$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Software/construvidas/src/models/Event.ts [app-route] (ecmascript)");
;
;
;
...
async function GET(req) {
    try {
        ...
        const query = __TURBOPACK__imported__module__$5b$project$5d2f$Software$2f$construvidas$2f$src$2f$models$2f$Event$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).sort({
            date: -1
        });
        const events = limit ? await query.limit(Number(limit)) : await query;
        return __TURBOPACK__imported__module__$5b$project$5d2f$Software$2f$construvidas$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(events);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10d46304._.js.map