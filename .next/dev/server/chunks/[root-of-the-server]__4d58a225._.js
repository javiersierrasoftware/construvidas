...
"[project]/Projects/en gravity/tritonweb/src/app/api/stories/[id]/featured/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req, { params }) {
    try {
        ...
        if (session.user.role !== "ADMIN") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Solo ADMIN puede modificar destacadas"
            }, {
                status: 403
            });
        }
        ...
        const updatedStory = await __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$src$2f$models$2f$Story$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, {
            featured
        }, {
            new: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d58a225._.js.map