  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2 bg-white border border-white/10 px-3 py-2 rounded-lg w-full md:w-1/3">
          ...
          >
            ...
            <div className="absolute top-3 right-3 flex gap-2 z-10">
              <Link
                ...
                className="p-2.5 bg-white rounded-lg border border-white/20 hover:bg-white/10 transition shadow-lg"
              >
              ...
              <Link
                ...
                className="p-2.5 bg-white rounded-lg border border-white/20 hover:bg-white/10 transition shadow-lg"
              >
                <Pencil size={20} className="text-accent-500" />
              </Link>
              <button
                onClick={() => setConfirmDeleteId(event._id)}
                title="Eliminar Evento"
                className="p-2.5 bg-white rounded-lg border border-white/20 hover:bg-red-500/20 transition shadow-lg"
              >
            ...
            <div className="relative w-full h-48 bg-white rounded-t-xl overflow-hidden">
              <Image
