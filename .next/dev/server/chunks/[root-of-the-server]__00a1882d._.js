...
"[project]/Projects/en gravity/tritonweb/src/app/api/events/admin/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        const event = await __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$src$2f$models$2f$Event$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id).lean();
        if (!event) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
...
async function PUT(req, { params }) {
    try {
        ...
        stringFields.forEach((field)=>{
            ...
            if (val !== null) updatedData[field] = val;
        });
        // Fechas
        const dateRawVal = formData.get("date");
        if (dateRawVal) updatedData.date = new Date(dateRawVal);
        const maxRegDateRawVal = formData.get("maxRegistrationDate");
        ...
        const distancesRawVal = formData.get("distances");
        if (distancesRawVal !== null) {
            updatedData.distances = distancesRawVal.split(",").map((d)=>d.trim());
        }
        const categoryRawVal = formData.get("category");
        if (categoryRawVal) {
            try {
                updatedData.category = JSON.parse(categoryRawVal);
            } catch (e) {
                console.error("Error parsing category", e);
            }
        }
        const shirtSizesRawVal = formData.get("shirtSizes");
        if (shirtSizesRawVal) {
            try {
                updatedData.shirtSizes = JSON.parse(shirtSizesRawVal);
            } catch (e) {
                console.error("Error parsing shirtSizes", e);
            }
        }
        const regPeriodsRawVal = formData.get("registrationPeriods");
        if (regPeriodsRawVal) {
            try {
                updatedData.registrationPeriods = JSON.parse(regPeriodsRawVal);
            } catch (e) {
                console.error("Error parsing regPeriods", e);
            }
        }
        if (imageUrl) updatedData.image = imageUrl;
        console.log("LOG API: Procediendo a actualizar evento con:", updatedData);
        const updatedEvent = await __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$src$2f$models$2f$Event$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, updatedData, {
            new: true,
            runValidators: true
        });
        if (!updatedEvent) {
...
async function DELETE(req, { params }) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        const deletedEvent = await __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$src$2f$models$2f$Event$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
        if (!deletedEvent) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$en__gravity$2f$tritonweb$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__00a1882d._.js.map