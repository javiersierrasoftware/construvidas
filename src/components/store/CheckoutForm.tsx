        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-4">
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-lg border transition ${shippingMethod === "pickup"
                  ? "bg-secondary-600/20 border-secondary-600 text-secondary-400"
                  : "bg-gray-800 border-gray-700 text-slate-700 hover:bg-gray-700"
                  }`}
              >
          ...
          {shippingMethod === "shipping" && (
            <div className="space-y-4 border-t border-white/10 pt-4 mt-2">
              ...
              <div>
                <label htmlFor="addressLine" className="block text-sm font-medium text-slate-800">
                  Dirección exacta
                </label>
                <input
                  type="text"
          ...
          {shippingMethod === "pickup" && (
            <p className="text-sm text-secondary-400/80 italic text-center">
