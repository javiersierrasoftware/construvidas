...
function NavLinks() {
  return (
    <>
      <Link href="/" className="text-slate-700 hover:text-secondary-600 transition font-medium">Inicio</Link>
      <Link href="/stories" className="text-slate-700 hover:text-secondary-600 transition font-medium">Comunidad</Link>
      <Link href="/discipulado" className="text-slate-700 hover:text-secondary-600 transition font-medium">Discipulado</Link>
      <Link href="/events" className="text-slate-700 hover:text-secondary-600 transition font-medium">Eventos</Link>
      <Link href="/tienda" className="text-slate-700 hover:text-secondary-600 transition font-medium">Tienda</Link>
      <Link href="/join" className="text-slate-700 hover:text-secondary-600 transition font-medium">Únete</Link>
    </>
  );
}
