      ...
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-6">
        <header className="space-y-2">
          ...
          <p className="text-slate-700 text-sm">
            ...
            solicitar visibilidad en la plataforma CONSTRUVIDAS. Nuestro equipo
        ...
        >
          ...
          <section className="space-y-3">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <label className="text-slate-800">Nombre / Entidad</label>
                <input
                  type="text"
                  name="organizerName"
                  value={form.organizerName}
                  onChange={handleChange}
                  className="w-full mt-1 bg-white/40 border border-white/10 rounded-xl px-3 py-2"
                  required
                />
              </div>
              <div>
                <label className="text-slate-800">Correo de contacto</label>
                <input
                  type="email"
                  name="organizerEmail"
              ...
              <div>
                <label className="text-slate-800">Teléfono / WhatsApp</label>
                <input
                  type="text"
                  name="organizerPhone"
          ...
          <section className="space-y-3">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                <label className="text-slate-800">Nombre del evento</label>
                <input
                  type="text"
                  name="name"
                  value={form.name}
              ...
              <div>
                <label className="text-slate-800">Fecha del evento</label>
                <input
                  type="date"
                  name="date"
                  value={form.date}
              ...
              <div>
                <label className="text-slate-800">Hora</label>
                <input
                  type="time"
                  name="time"
                  value={form.time}
              ...
              <div className="md:col-span-2">
                <label className="text-slate-800">Lugar / Ciudad</label>
                <input
                  type="text"
                  name="location"
                  value={form.location}
              ...
              <div>
                <label className="text-slate-800">Tipo de evento / Ministerio</label>
                <select
                  name="sportType"
              ...
              <div>
                <label className="text-slate-800">Precio de inscripción</label>
                <input
                  type="text"
                  name="price"
                  value={form.price}
            ...
            <div>
              <label className="text-slate-800">Descripción del evento</label>
              <textarea
                name="description"
                value={form.description}
                onChange={handleChange}
                rows={4}
                className="w-full mt-1 bg-white/40 border border-white/10 rounded-xl px-3 py-2 resize-none"
          ...
          <section className="space-y-2">
            <label className="inline-flex items-start gap-2 text-xs text-slate-800">
              ...
              <span>
                ...
                publicación de mi evento en CONSTRUVIDAS está sujeta a revisión, así como
