      ...
      case "COMPLETED":
        return (
          <>
            ...
            {eventId && (
              <Link href={`/events/${eventId}`} className="mt-6 inline-block bg-secondary-600 px-6 py-2 rounded-md font-semibold text-black hover:bg-secondary-500">
                  Volver al Evento
              </Link>
            )}
          </>
        ...
        return (
          <>
            ...
            <p className="mt-2 text-slate-700">
             ...
             {eventId && (
              <Link href={`/events/register/${eventId}`} className="mt-6 inline-block bg-secondary-600 px-6 py-2 rounded-md font-semibold text-black hover:bg-secondary-500">
                  Intentar de Nuevo
              </Link>
            )}
          </>
